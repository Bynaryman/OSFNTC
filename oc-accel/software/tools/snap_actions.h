...
static const struct actions_tab snap_actions[] = {
  ...
  { "IBM", 0x10143004, 0x10143004, "HLS Helloworld_python (1024b)" },
  ...
  { "IBM", 0x1014300D, 0x1014300D, "HLS Image_Filter  (512b)" },
  { "IBM", 0x1014300E, 0x1014300E, "HLS Memcopy_512   (512b)" },
  { "IBM", 0x1014300F, 0x1014300F, "HLS Decimal Mult  (512b)" },
  { "IBM", 0x10143010, 0x10143010, "HLS UDP           (512b)" },
  { "IBM", 0x10143011, 0x1014FFFF, "Reserved for HLS IBM Actions" },
  { "PSI", 0x52320100, 0x52320100, "JUNGFRAU X-ray Detector Data Acquisition and Analysis" },
  { "PSI", 0x52320101, 0x523201FF, "X-ray Detector Data Acquisition and Analysis" },
