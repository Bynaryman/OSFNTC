...
#
# Generated by Vivado on Tue Dec 14 11:23:20 CET 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L work -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top work.top work.glbl -log elaborate.log -sv_lib libdpi -sv_root .
}
