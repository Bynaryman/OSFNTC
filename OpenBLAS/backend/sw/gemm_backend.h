...
static int gemm_backend_test (
	...
	VERBOSE3(stdout, "time card allocation (us): %lld, %lld\%\n",time_card_allocation, (float)(time_card_allocation/time_total)*100);
	VERBOSE3(stdout, "time attach action (us): %lld, %lld\%\n",time_attach_action, (float)(time_attach_action/time_total)*100);
	VERBOSE3(stdout, "time memory allocation (us): %lld, %lld\%\n",time_memory_allocation, (float)(time_memory_allocation/time_total)*100);
	VERBOSE3(stdout, "time action prepare(us): %lld, %lld\%\n",time_prepare_action, (float)(time_prepare_action/time_total)*100);
	VERBOSE3(stdout, "time action execute(us): %lld, %lld\%\n",time_action_execute, (float)(time_action_execute/time_total)*100);
