...
configs_proposal1 = [
        ...
        (200,"posit16:0"      ,32 ,  31,  14, 5,13,   5, -24, 2 ),  # posit<16,0> x alpha
        (200,"posit16:0"      ,32 ,  31,  14, 5,13,  28, -28, 7 ),  # posit<16,0> x beta
        (200,"posit16:0"      ,32 ,  31,  14, 5,13,  40, -50, 9 ),  # posit<16,0> x gamma

        (200,"posit16:1"      ,32 ,  31,  28, 6,12,   5, -24, 2 ),  # posit<16,1> x alpha
        (200,"posit16:1"      ,32 ,  31,  28, 6,12,  56, -56,15 ),  # posit<16,1> x beta
        (200,"posit16:1"      ,32 ,  31,  28, 6,12,  40, -50, 9 ),  # posit<16,1> x gamma

        (200,"posit16:2"      ,32 ,  31,  56, 7,11, 112,-112,31 ),  # posit<16,2> x alpha
        (200,"posit16:2"      ,32 ,  31,  56, 7,11, 112,-112,31 ),  # posit<16,2> x beta
        (200,"posit16:2"      ,32 ,  31,  56, 7,11, 112,-112,31 ),  # posit<16,2> x gamma

        (200,"posit32:0"      ,16 ,  15,  30, 6,29,   5, -56, 2 ),  # posit<32,0> x alpha
        (200,"posit32:0"      ,16 ,  15,  30, 6,29,  60, -60, 7 ),  # posit<32,0> x beta
        (200,"posit32:0"      ,16 ,  15,  30, 6,29,  40, -50, 9 ),  # posit<32,0> x gamma

        (200,"posit32:1"      ,16 ,  15,  60, 7,28,   5, -56, 2 ),  # posit<32,1> x alpha
        (200,"posit32:1"      ,16 ,  15,  60, 7,28, 120,-120, 15),  # posit<32,1> x beta
        (200,"posit32:1"      ,16 ,  15,  60, 7,28,  40, -50, 9 ),  # posit<32,1> x gamma

        (200,"posit32:2"      ,16 ,  15, 120, 8,27,   5, -56, 2 ),  # posit<32,2> x alpha
        (200,"posit32:2"      ,16 ,  15, 120, 8,27, 240,-240, 31),  # posit<32,2> x beta
        (200,"posit32:2"      ,16 ,  15, 120, 8,27,  40, -50, 9 ),  # posit<32,2> x gamma

        (200,"posit64:1"      ,8  ,   7, 124, 8,60,   5,-121, 2 ),  # posit<64,1> x alpha
        (200,"posit64:1"      ,8  ,   7, 124, 8,60, 248,-248, 15),  # posit<64,1> x beta
        (200,"posit64:1"      ,8  ,   7, 124, 8,60,  40, -50, 9 ),  # posit<64,1> x gamma

        (200,"posit64:2"      ,8  ,   7, 248, 9,59,   5,-121, 2 ),  # posit<64,2> x alpha
        (200,"posit64:2"      ,8  ,   7, 248, 9,59, 496,-496, 31),  # posit<64,2> x beta
        (200,"posit64:2"      ,8  ,   7, 248, 9,59,  40, -50, 9 ),  # posit<64,2> x gamma

        (200,"posit64:3"      ,8  ,   7, 496,10,58,   5,-121, 2 ),  # posit<64,3> x alpha
        (200,"posit64:3"      ,8  ,   7, 496,10,58, 992,-992, 63),  # posit<64,3> x beta
        (200,"posit64:3"      ,8  ,   7, 496,10,58,  40, -50, 9 ),  # posit<64,3> x gamma
