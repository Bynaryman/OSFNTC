...
#define DBG_PARM_RETRY_PERCENT		0x6
#define DBG_PARM_FAILED_PERCENT		0x7
#define DBG_PARM_PENDING_PERCENT	0x8
#define DBG_PARM_DERROR_PERCENT		0x9
#define DBG_PARM_INT_RETRY_PERCENT	0xa
