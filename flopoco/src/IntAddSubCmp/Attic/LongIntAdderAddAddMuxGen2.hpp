#ifndef LongIntAdderAddAddMuxGen2S_HPP
#define LongIntAdderAddAddMuxGen2S_HPP
#include <vector>
#include <sstream>
#include <gmp.h>
#include <gmpxx.h>
...
namespace flopoco{
	...
	/** The LongIntAdderAddAddMuxGen2 class for experimenting with long fast adders. */
	class LongIntAdderAddAddMuxGen2 : public Operator
	{
	public:
		/**
		 * The LongIntAdderAddAddMuxGen2 constructor
